...
<div style="display: inline_block"><br>
  ...
  <img align="center" alt="David-Hpe" height="30" width="40" src="<svg viewBox="0 -12 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M2 6H46V18H2V6ZM5 9H43V15H5V9Z" fill="#00C781"></path> </g></svg>" />
